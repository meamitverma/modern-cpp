...
// void processEnginerIOTs(int& value) {
//     std::cout << "Value processed : " << value << std::endl;
// }

void processEnginerIOTs(int &value)
{
    std::string iot[5] = {"Oil Filter IOT", "Petrol IOT", "Piston", "Cumbersion", "Battery"};
    std::cout << "\t State Started : " << std::endl;
    std::cout << "\t State Processing: " << std::endl;
    std::cout << "IOT processed : " << iot[value - 1] << std::endl;
...
int main()
{
    ...
    executeThreads(processEnginerIOTs, values.begin(), values.end());
